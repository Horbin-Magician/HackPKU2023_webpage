  ...
  v-row
    ...
    v-col
      ...
      v-col.text-line-height-2
        ...
        br
        br
        | 真格基金陆续投资了 800 余家创业公司，从早期陪伴了小红书、Nuro、依图科技、地平线、Momenta、燧原科技、晶泰科技、AutoX、思谋科技、爱笔智能、找钢网、罗辑思维、兴盛优选、美菜、出门问问、蜜芽等公司成长为独角兽企业。自 2011 年起，真格基金被投公司世纪佳缘(NASDAQ: DATE)、聚美优品(NYSE: JMEI)、兰亭集势(NYSE: LITB)、51Talk(NYSE: COE)、牛电科技(NASDAQ: NIU)、老虎证券(NASDAQ: TIGR)、亿航智能(NASDAQ: EH)、逸仙电商(NYSE: YSG)、优客工场(NASDAQ: UK) 、水滴(NYSE: WDH)、格灵深瞳(688207.SH) 、禾赛科技（NASDAQ：HSAI）等陆续上市，超过110个项目通过多种方式实现退出，获得投资回报。自 2014 年清科“中国股权投资年度排名”设立早期投资机构排名以来，真格基金已连续 6 年获得“中国早期投资机构 30 强”第 1 名；真格基金创始人徐小平从 2016 年起连续五年入选福布斯“全球最佳创投人榜单(the Midas List)”，在2019年榜单中排名第11位；真格基金创始合伙人兼CEO方爱之从 2019 年起连续 4 年上榜“全球最佳创投人”榜单， 并在 2022 年排名第 12 位。
        br
        br
